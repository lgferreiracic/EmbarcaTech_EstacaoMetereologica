...
void display_alert(ssd1306_t *ssd, float bmp280_temperature, float bmp280_altitude, float aht20_temperature, float aht20_humidity, bool web_server_initialized, bool cor); // Exibe um alerta no display OLED SSD1306
